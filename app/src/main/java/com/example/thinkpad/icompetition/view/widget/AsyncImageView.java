...
public class AsyncImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public AsyncImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.AsyncImageView_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.AsyncImageView_border_color, DEFAULT_BORDER_COLOR);
    ...
    public void setAvatar(String uri, @DrawableRes int defaultResId) {
        ...
        if(uri!=null){
            ...
            if (bitmap != null) {
                ...
                if (cache != null) {
                    this.setImageBitmap(BitmapFactory.decodeFile(cache.getAbsolutePath()));
                } else {
                    ImageLoader.getInstance().displayImage(uri, this, options);
                }
            }
        }else {
